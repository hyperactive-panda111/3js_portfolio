                ...
                <div className='grid-container'>
                    <img src='/assets/grid3.png' alt='grid-3'
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>I love solving problems and building solutions through programming.
                            Coding is not just my profession - it is my passion.</p>
                        </div>
                </div>
            </div>
                ...
                <div className='grid-container'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <div className='copy-container' onClick={handleCopy}>
                            ...
                            text-white'>amomensah300@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
